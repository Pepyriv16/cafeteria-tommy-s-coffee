...
<html lang="en">
    ...
    <body>
            ...
            <section class="home" id="home">
                <div class="home__container bd-container bd-grid">
                    <div class="home__data">
                        <h2 class="home__subtitle">No es solo cafe</h2> <h1 class="home__title"><span>es</span> Tommy's Coffee</h1>
            ...
            <section class="about section bd-container" id="about">
                <div class="about__container  bd-grid">
                    <div class="about__data">
                        ...
                        <h2 class="section-title about__initial">Espera mas que un cafe</h2>
                        <p class="about__description">No solo somos proveedores apasionados de café, sino de todo lo demás que conlleva una experiencia de cafetería completa y gratificante. También ofrecemos una selección de tés de primera calidad, pasteles finos y otras delicias para complacer el paladar. Y la música que escuchas en la tienda es elegida por su arte y atractivo. <br>No es raro ver a personas que vienen a Starbucks para charlar, reunirse o incluso trabajar. Somos un lugar de reunión del vecindario, parte de la rutina diaria, y no podríamos estar más felices por ello. </p>
            ...
            <section class="services section bd-container" id="services">
                ...
                <div class="services__container  bd-grid">
                    ...
                    <div class="services__content">
                        ...
                        <p class="services__description">Una tarjeta de regalo de Tomy's Coffee es una forma conveniente de pagar y ganar puntos tommy para obtener recompensas. Esta tarjeta de regalo en línea es un gran regalo para los amantes del café.</p>
                    </div>
                    <div class="services__content">
        ...
        <footer class="footer section bd-container">
            <div class="footer__container bd-grid">
                ...
                <div class="footer__content">
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="footer__link">Sube tu idea</a></li>
                    </ul>
                </div>
            ...
            <p class="footer__copy">&#169; 2023 Tommy's Coffee® licenciado.<br>&#169; 2023 Tommy's Coffee®.todos los derechos reservados</p>
        </footer>
